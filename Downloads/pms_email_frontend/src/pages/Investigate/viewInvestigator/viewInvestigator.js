...
const ViewInvestigator = () => {
  ...
  const handleClick = async () => {
    ...
    if (response.status == 200) {
      ...
      toast.error(response?.message || "error adding study, try again!!");
    }
    setLoading(false);
    setNewUserFile(null);
  };
                          ...
                          >
                            ...
                            <div style={{ marginTop: 16 }}>
                              ...
                              <div style={{ marginTop: 8 }}>
                                <Text type="danger">
                                  ⚠️ <strong>Note:</strong> <b>PAN Number</b>{" "}
                                  column is <strong>mandatory</strong> in your
                                  CSV/Excel file.
                                </Text>
                              </div>
                            </div>
                            ...
                            {/* <Alert
                              message="Pan_No column is mandatory"
                              description="Make sure the Pan_No field is filled in every row of your CSV/Excel file."
                              type="warning"
                              showIcon
                              style={{ marginTop: 16 }}
                            /> */}
                            ...
                            <div style={{ marginTop: 8 }}>
                              <a
                                href="https://tatva-pmsusers-backend.evalus.in/sample.xlsx"
                                download
                                target="_blank"
