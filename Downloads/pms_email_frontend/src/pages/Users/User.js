...
const User = () => {
  ...
  const handleSubmit = async (values) => {
    const response = await postReq("admin/create-user", {
      ...values,
    });
  ...
  const handleUpdate = async (values) => {
    ...
    const response = await postReq(`admin/update-user/${selectedField._id}`, {
      ...values,
    });
    if (response.status == 200) {
      setSelectedField({});
  ...
  const fetchUser = async () => {
    ...
    const response = await postReq("admin/users", {
      page: current,
      limit: pageSize,
      sortField,
        ...
        >
          <Row gutter={16}>
            ...
            <Col xs={24} sm={12}>
              ...
              >
                <Input maxLength={30} placeholder="Enter" />
              </Form.Item>
            </Col>
            ...
            <Col xs={24} sm={12} md={12}>
              <Form.Item
                ...
                name="role"
                rules={[
                  { required: true, message: "Please select work type status" },
                ]}
              >
                <Radio.Group>
                  <Radio value="CRM">CRM</Radio>
                  <Radio value="CMT">CMT</Radio>
                </Radio.Group>
              </Form.Item>
            </Col>
            <Col xs={24} sm={12} md={12}>
              <Form.Item
                ...
                name="password"
                rules={[
                  { required: true, message: "Please enter user passsword" },
                ]}
              >
                <Input.Password
                  ...
                  iconRender={(visible) =>
                    visible ? (
                      <EyeTwoTone style={{ marginLeft: "5px" }} />
                    ) : (
                      <EyeInvisibleOutlined />
                    )
                  }
